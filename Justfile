...
# Doesn't print the command that is being run

COVERAGE_MIN := env_var_or_default("COVERAGE_MIN", "100")
SOLHINT := "dev/node_modules/.bin/solhint"
FORGE := "dev/node_modules/.bin/forge"
ANVIL := "dev/node_modules/.bin/anvil"
CAST := "dev/node_modules/.bin/cast"
CHISEL := "dev/node_modules/.bin/chisel"
NPM_BIN := "dev/node_modules/.bin"
